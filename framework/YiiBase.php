...
class YiiBase
{
	...
	private static $_coreClasses=array(
        ...
        'CDIContainer' => '/base/CDIContainer.php',
        ...
        'CDbServiceLocator' => '/db/CDbServiceLocator.php',
        'CDbConnectionRouter' => '/db/CDbConnectionRouter.php',
        'CDbSingleConnectionRouter' => '/db/CDbSingleConnectionRouter.php',
