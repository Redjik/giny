...
class MigrateCommand extends CConsoleCommand
{
	...
	protected function getDbConnection()
	{
		if($this->_db!==null)
			return $this->_db;
		elseif(($this->_db=Yii::app()->getComponent($this->connectionID)) instanceof CDbServiceLocator)
			return $this->_db;

		echo "Error: CMigrationCommand.connectionID '{$this->connectionID}' is invalid. Please make sure it refers to the ID of a CDbServiceLocator application component.\n";
		exit(1);
	}
