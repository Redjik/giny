...
abstract class GPoolSchema extends CComponent
{
    /**
    ...
    public static function factory(CDbConnection $connection)
    {
        $connectionString = $connection->connectionString;
        $driver=self::getDriverName($connectionString);
        if(isset(self::$driverMap[$driver]))
            return Yii::createComponent(self::$driverMap[$driver],$connection);
        else
