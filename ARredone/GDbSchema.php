...
/**
 * GDbSchema is the base class for retrieving metadata information.
 *
 ...
 * @since 1.0
 */
abstract class GDbSchema extends CComponent implements IDbSchema
{
	/**
    ...
    /**
     * Constructor.
     * @param GConnectionManager $pool database connection.
     * @param $config
     */
    public function __construct(GConnectionManager $pool,$config)
    {
    ...
    public static function factory(GConnectionManager $pool,array $config)
    {
        ...
        return Yii::createComponent('G'.$driver.'Schema',$pool,$config);
    }
