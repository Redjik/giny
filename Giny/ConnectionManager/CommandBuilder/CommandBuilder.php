...
namespace Giny\ConnectionManager\CommandBuilder;
...
class CommandBuilder
{
	...
	{
		if (!isset(self::$initiatedBuilders[$driverType])){
			self::$initiatedBuilders[$driverType] = new CommandBuilder();
		}

		return self::$initiatedBuilders[$driverType];
	}
